	...
	return (
		<div id='Landing' className='AppContent'>
			...
			<div id='menu'>
				...
				<p className='text'>
					I'm <span className='focus'>Kevin Baumgartner</span>,
					<br />
				...
				<p className='text'>
					...
					<br />
					using the <a href='https://www.mongodb.com/mern-stack' target='_blank' className='focus-link'>MERN solution stack</a> to create beautiful solutions for everyday situtions.
				</p>
				<div id='links-social'>
