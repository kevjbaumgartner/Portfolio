...
export default function Landing() {
	return (
		<div id='Landing' className='AppContent'>
			...
			<div id='menu'>
				<p id='text-1' className='text'>Hey there, nice to meet you!</p>
				<p id='text-2' className='text'>I'm <span id='title'>Kevin Baumgartner</span>,</p>
				<p id='text-3' className='text'>a full stack developer.</p>
				<div id='links-local'>
