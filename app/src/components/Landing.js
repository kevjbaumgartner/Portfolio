		...
		<div id='Landing' className='AppContent'>
			...
			<div id='menu'>
				<div className='text'>
					...
					<br /><br />
					I specialize in web development, using the <a href='https://www.mongodb.com/mern-stack' target='_blank' className='focus-link'>MERN solution stack</a> to create beautiful solutions for everyday situtions.
					<br /><br />
					<div id='links-social'>
